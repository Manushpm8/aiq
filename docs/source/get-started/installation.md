...
|-----------|---------------|-------------------------------|
| LLM (intent classifier, orchestrator, planner) | `nvidia/nemotron-3-super-120b-a12b` | [Nemotron 3 Super support matrix](https://build.nvidia.com/nvidia/nemotron-3-super-120b-a12b/modelcard) |
| LLM (deep research researcher) | `nvidia/nemotron-3-super-120b-a12b` | [Nemotron 3 Super support matrix](https://build.nvidia.com/nvidia/nemotron-3-super-120b-a12b/modelcard) |
| LLM (deep research orchestrator/planner, optional) | `openai/gpt-oss-120b` | [GPT OSS support matrix](https://build.nvidia.com/openai/gpt-oss-120b/modelcard) |
...
| VLM (image/chart extraction, optional) | `nvidia/nemotron-nano-12b-v2-vl` | [Vision language model support matrix](https://build.nvidia.com/nvidia/nemotron-nano-12b-v2-vl/modelcard) |
